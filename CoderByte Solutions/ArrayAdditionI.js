// Using the JavaScript language, have the function ArrayAdditionI(arr) take the array of numbers stored in arr and 
...
function ArrayAdditionI(arr){
	...
	function checkSum(largest, array) {
	    if (array.length == 0) {
	        return largest == 0;
	    }
	    var n = array[0];
	    array = array.slice(1);
	    return checkSum(largest, array) || checkSum(largest - n, array);
	}
	return checkSum(largest, arr);
}
